...
class Web3StorageService extends base_storage_js_1.StorageService {
    constructor(token, config) {
        super();
        this.serviceBaseUrl = 'ipfs://';
        this.serviceInstance = new web3_storage_1.Web3Storage(Object.assign({ token }, config));
    }
    uploadJson(jsonData, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = JSON.stringify(jsonData);
            const fileJsonData = new web3_storage_1.File([data], 'data.json', { type: 'application/json' });
            const cid = yield this.serviceInstance.put([fileJsonData]);
    ...
    uploadImage(path, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cid = yield this.serviceInstance.put([imageFile]);
    ...
    uploadVideo(path, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cid = yield this.serviceInstance.put([videoFile]);
            return { id: cid, metadata: {} };
        });
    }
    uploadFile(path, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cid = yield this.serviceInstance.put([file]);
            return { id: cid, metadata: {} };
        });
    }
}
